#-------------------------------------------------
#
# Project created by QtCreator 2021-05-24T22:56:10
#
#-------------------------------------------------
...
SOURCES += \
        joints_control_panel.cpp

HEADERS += \
        joints_control_panel.h \
        ui_joints_control_panel.h
FORMS += \
        joints_control_panel.ui
unix {
    target.path = /usr/lib
    INSTALLS += target
}
